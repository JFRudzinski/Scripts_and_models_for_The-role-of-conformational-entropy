...
/data/isilon/rudzinski/soft_backup/anaconda-cluster/bin/python Calc_Alpha_for_Hcond_mpp.py

/data/isilon/rudzinski/soft_backup/anaconda-cluster/bin/python Calc_Hcond_fol_mpp.py  

/data/isilon/rudzinski/soft_backup/anaconda-cluster/bin/python Calc_Hcond_unf_mpp.py
