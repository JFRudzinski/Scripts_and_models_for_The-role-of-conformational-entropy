...
#$ -cwd
#$ -j y
#$ -N QuadWell_CG_np-16_OPT-fixed-lambda_MC-fixed-step_free-pi
#$ -pe PE_16 16
#$ -e $JOB_ID.log
#$ -o $JOB_ID_2.log
#$ -l h_rt=36:00:00
...
/data/isilon/rudzinski/soft_backup/anaconda-cluster/bin/mpiexec -n 16 /data/isilon/rudzinski/soft_backup/anaconda-cluster/bin/python /home/theorie/rudzinski/soft/biased-MSM-2/biased_msm/LR-fitting.py $PWD
