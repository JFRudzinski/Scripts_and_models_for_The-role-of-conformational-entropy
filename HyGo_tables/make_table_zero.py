...
#np.savetxt('pot_r6.dat', np.vstack([r, pot]).T, fmt='%0.8f')
#np.savetxt('force_r6.dat', np.vstack([r, force]).T, fmt='%0.8f')
np.savetxt('table_.xvg', np.vstack([r, pot_C, force_C, pot_r6, force_r6, pot_r12, force_r12]).T, fmt='%0.8f')
